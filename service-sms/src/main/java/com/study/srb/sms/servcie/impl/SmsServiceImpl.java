package com.study.srb.sms.servcie.impl;
...
import com.study.common.exception.Assert;
import com.study.common.exception.BusinessException;
import com.study.common.result.ResponseEnum;
import com.study.srb.sms.servcie.SmsService;
...
/**
 * create by xiaocai on 2021/11/21 6:53
 **/
@Service
@Slf4j
public class SmsServiceImpl implements SmsService {
    ...
    public void send(String mobile, String templateCode, Map<String,Object> param) {
        ...
        try {
            ...
            String data = "{\"RequestId\":\"651534684313246548\",\"Message\":\"OK\",\"BizId\":\"4654643354354\",\"Code\":\"OK\"}";
